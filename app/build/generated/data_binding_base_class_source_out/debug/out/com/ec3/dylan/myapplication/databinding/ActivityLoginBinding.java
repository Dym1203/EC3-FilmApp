...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull EditText edtEmail, @NonNull EditText edtPassword, @NonNull Guideline guidelineMedium,
      @NonNull TextView txtEmail, @NonNull TextView txtPassword, @NonNull TextView txttitle) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, edtEmail, edtPassword,
          guidelineMedium, txtEmail, txtPassword, txttitle);
    }
